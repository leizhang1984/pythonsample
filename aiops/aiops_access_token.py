...
#获得VM的活动日志
def get_vm_activity_log(clientcredential,subscription_id, rg_name, vm_name, vm_id, issue_time_iso8601):
    # issue_time_iso8601
...
def get_vm_resource_health(clientcredential,subscription_id, rg_name, vm_name, vm_id):
    ...
    resource_health_client = ResourceHealthMgmtClient(clientcredential, subscription_id)
...
#获得虚拟机的指标
def get_vm_monitor_metrics(clientcredential,subscription_id, rg_name, vm_name, vm_id, issue_time_str):
...
def request_ai_foundary_final(subscription_id,rg_name,vm_name,private_ip,issue_time, vmszie):
    ...
    client = OpenAI(
        base_url="https://leizha-foundry01.services.ai.azure.com/openai/v1",
        api_key=""
    )
    ...
    response = client.chat.completions.create(
        model = "gpt-5.4",  # Replace with your deployed model name
        messages = messages,

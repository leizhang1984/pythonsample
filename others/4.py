...
def raw_socket_keepalive(url, port=443, requests_count=300):
    ...
    context.options |= ssl.OP_LEGACY_SERVER_CONNECT  # 启用不安全的遗留重新协商
...
if __name__ == "__main__":
    #target_url = "https://awsgwlb.leiweb.net"
    #target_url = "https://pa-nlb-876b517a8941d030.elb.ap-east-1.amazonaws.com/"

    target_url = "https://pa-nlb-876b517a8941d030.elb.ap-east-1.amazonaws.com/"
    
    thread_count = 50  # 线程数量
    requests_count = 1000  # 每个线程的请求数量

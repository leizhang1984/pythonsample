...
rg_name = "defaultrg"
vnet_name = "NIO-EU"
subnet_name = "PROD-EU-AZURE-TOD-BIGDATA-01"
nic_name = "p-azeu3-dpd-hdfs-dn-021-nic"
#创建的虚拟机名称
vm_name = "p-azeu3-dpd-hdfs-dn-021"
#之前提前创建好vmss，类型必须是Flexible，Initial instance count必须为0
vmss_name = "dpd-insight-azeu-hadoop-dn-prod-00"
#计算机名称
computer_name = "p-azeu3-dpd-hdfs-dn-021"

...
def main():
    ...
    query = QueryRequest(
        query=f'''healthresourcechanges 
            ...
            | where AnnotationName contains 'VirtualMachineHostCrashed' or AnnotationName contains 'VirtualMachineHostRebootedForRepair' or AnnotationName contains 'VirtualMachineMigrationInitiatedForRepair' or AnnotationName contains 'VirtualMachineStorageOffline' or AnnotationName contains 'VirtualMachinePossiblyDegradedDueToHardwareFailureWithRedeployDeadline' or AnnotationName contains 'VirtualMachineMigrationScheduledForDegradedHardware' or AnnotationName contains 'VirtualMachinePossiblyDegradedDueToHardwareFailure' or AnnotationName contains 'VirtualMachineScheduledForServiceHealing' or AnnotationName contains 'AccelnetUnhealthy' or AnnotationName contains 'AccelnetHealthy' or AnnotationName contains 'LiveMigrationSucceeded' or AnnotationName contains 'LiveMigrationFailure' or AnnotationName contains 'VirtualMachineMigrationInitiatedForPlannedMaintenance' or AnnotationName contains 'VirtualMachineRebootInitiatedForPlannedMaintenance' or AnnotationName contains 'VirtualMachinePlannedFreezeSucceeded' or AnnotationName contains 'VirtualMachinePlannedFreezeFailed' or AnnotationName contains 'VirtualMachineProvisioningTimedOut' or AnnotationName contains 'VirtualMachineCrashed'
